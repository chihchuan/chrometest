...
["chrome.runtime", "package:chrome/gen/runtime.dart", , O, {
  ...
  ChromeRuntime: {
    ...
    ChromeRuntime$_$0: function() {
      var getApi = new O.ChromeRuntime$__closure(this);
      this._onStartup = G.ChromeStreamController$noArgs(getApi, "onStartup", null);
      this._onInstalled = G.ChromeStreamController$oneArg(getApi, "onInstalled", G.mapify$closure(), null, P.Map);
      this._onSuspend = G.ChromeStreamController$noArgs(getApi, "onSuspend", null);
      this._onSuspendCanceled = G.ChromeStreamController$noArgs(getApi, "onSuspendCanceled", null);
      this._onUpdateAvailable = G.ChromeStreamController$oneArg(getApi, "onUpdateAvailable", G.mapify$closure(), null, [P.Map, P.String, null]);
      this._onBrowserUpdateAvailable = G.ChromeStreamController$noArgs(getApi, "onBrowserUpdateAvailable", null);
      this._onConnect = G.ChromeStreamController$oneArg(getApi, "onConnect", O._createPort$closure(), null, O.Port);
      this._onConnectExternal = G.ChromeStreamController$oneArg(getApi, "onConnectExternal", O._createPort$closure(), null, O.Port);
      this._onMessage = G.ChromeStreamController$threeArgs(getApi, "onMessage", O._createOnMessageEvent$closure(), null, O.OnMessageEvent);
      this._onMessageExternal = G.ChromeStreamController$threeArgs(getApi, "onMessageExternal", O._createOnMessageExternalEvent$closure(), null, O.OnMessageExternalEvent);
      this._onRestartRequired = G.ChromeStreamController$oneArg(getApi, "onRestartRequired", G.selfConverter$closure(), null, P.String);
    },
    static: {ChromeRuntime$_: function() {
        var t1 = new O.ChromeRuntime(null, null, null, null, null, null, null, null, null, null, null);
  ...
  Port: {
    "^": "ChromeObject;_onDisconnect,_onMessage,jsProxy"
  },
  MessageSender: {
  ...
  PlatformInfo: {
    "^": "ChromeObject;jsProxy",
    get$arch: function() {
      return J.$index$asx(this.jsProxy, "arch");
    }
  }
}],
["chrome.src.common", "package:chrome/src/common.dart", , G, {
  ...
  ChromeCompleter: {
    ...
    ChromeCompleter$oneArg$1: function(transformer) {
      this._callback = new G.ChromeCompleter$oneArg_closure(this, transformer);
    },
    static: {ChromeCompleter$oneArg: function(transformer) {
        var t1 = new G.ChromeCompleter(H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]), null);
  ...
  ChromeStreamController: {
    ...
    }, "call$0", "get$_ensureHandlerAdded", 0, 0, 17],
    ...
    }, "call$0", "get$_removeHandler", 0, 0, 17],
    ...
    ChromeStreamController$threeArgs$4: function(_apiProvider, _eventName, transformer, returnVal, $T) {
      var t1 = this.get$_ensureHandlerAdded();
      this._controller = P.StreamController_StreamController$broadcast(this.get$_removeHandler(), t1, false, $T);
      this._listener = new G.ChromeStreamController$threeArgs_closure(this, transformer, returnVal);
    },
  ...
  ChromeStreamController$threeArgs_closure: {
    ...
    }, "call$0", "call$3", null, null, null, null, 0, 6, null, 21, 21, 21, 6, 7, 8, "call"],
    $isFunction: true
  }
}],
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 51, 22, 23],
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 15, 34],
...
["", "file:///5B2021128E69088E56336586D3BE82C3:chromeApp-testchrome/web/main.dart", , D, {
  "^": "",
  main: [function() {
    var t1 = J.get$onClick$x(document.querySelector("#clickBtn"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(D.clickBtn$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  clickBtn: [function(e) {
    ...
    completer = G.ChromeCompleter$oneArg(O._createPlatformInfo$closure());
    J.$index$asx(t2, "runtime").callMethod$2("getPlatformInfo", [completer._callback]);
    completer._completer.future.then$1(new D.clickBtn_closure());
  }, "call$1", "clickBtn$closure", 2, 0, 36, 2],
  clickBtn_closure: {
    "^": "Closure:15;",
    call$1: [function(m) {
      document.querySelector("#text_id").textContent = m.get$arch();
      return;
...
"arg3",
"arg4",
{func: "Port__JsObject", ret: O.Port, args: [P.JsObject]},
{func: "OnMessageEvent__JsObject_JsObject_JsObject", ret: O.OnMessageEvent, args: [P.JsObject, P.JsObject, P.JsObject]},
{func: "OnMessageExternalEvent__JsObject_JsObject_JsObject", ret: O.OnMessageExternalEvent, args: [P.JsObject, P.JsObject, P.JsObject]},
{func: "PlatformInfo__JsObject", ret: O.PlatformInfo, args: [P.JsObject]},
...
function dart_precompiled($collectedClasses) {
  ...
  function Port(_onDisconnect, _onMessage, jsProxy) {
